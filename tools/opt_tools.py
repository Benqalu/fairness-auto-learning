...
class OptTools():
    ...
    def set_distortion(self, get_distortion, clist=[]):
        ...
        for i in range(self.dfD.shape[0]):
            ...
            if 'credit' in old_values and old_values['credit']==0.0:
                old_values['credit']='Bad Credit'
            for j in range(self.dfD.shape[1]):
                new_values = cols_dict[j]
                if 'credit' in new_values and new_values['credit']==0.0:
                    new_values['credit']='Bad Credit'
